...
#####SCRIPT FOR DEN KVANTITATIVE ANALYSEN I MASTEROPPGAVE OM IDENTITETSMISBRUK BEGÅTT AV NÆRSTÅENDE#####
...
#OPERASJONALISERING AV VARIABLER TIL REGRESJONSMODELL 1 (Presentert i Tabell 3 i oppgaven)-----
...
år_mellom_dom_straff <- lm(år_mellom_straff ~ as.factor(nærstående) +  as.factor(låne_svindel) + as.factor(indikasjon_prof)  + sum_svindel_100k + as.factor(annet_tiltale) + as.numeric(num_S) + as.numeric(num_K) , data= straffe_saker)
...
#prosentandel med saker med nærstående gjerningsperson------
#presentert i delkapittel Tabell 2, del 5.1 i oppgaven
